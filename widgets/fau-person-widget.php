...
class FAUPersonWidget extends WP_Widget {
	...
	if (isset($instance['bild'])) {
        ...
        echo FAU_Person_Shortcodes::fau_person_sidebar($id, $title, 0, $options['organisation'], $options['abteilung'], $options['position'], 1, 1, $options['adresse'], 1, $options['telefon'], $options['fax'], 0, $options['mail'], $options['webseite'], 0, $options['kurzauszug'], $options['sprechzeiten'], 0, $bild, 1);
        echo $after_widget;
    }
