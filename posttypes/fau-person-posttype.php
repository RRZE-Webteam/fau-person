...
$person_fields = array(
    ...
    '_person_typ' => array(
        ...
        'description' => '',
        'type' => 'select',
        'options' => array('real' => 'Reale Person',
            'pseudo' => 'Pseudonym',
    ...
    '_person_strasse' => array(
        'default' => 'false',
        'title' => __('Straße und Hausnummer', self::textdomain),
        'description' => '',
        'type' => 'text',
        'meta_box' => 'fau_person_info',
        'location' => 'person'),
    '_person_plz' => array(
        'default' => 'false',
        'title' => __('Postleitzahl', self::textdomain),
        'description' => '',
        'type' => 'text',
        'meta_box' => 'fau_person_info',
        'location' => 'person'),
